...
/* RFC 8894 section 3.3.3: IssuerAndSerialNumber ::= SEQUENCE { issuer Name,
 * serialNumber }. The issuer Name is picked as for IssuerAndSubject, the serial
 * is carried verbatim, and the parser finds it again. */
